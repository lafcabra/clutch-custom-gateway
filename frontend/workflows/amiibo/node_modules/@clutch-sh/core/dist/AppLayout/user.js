...
import { Avatar as MuiAvatar, ClickAwayListener, Divider as MuiDivider, Grow as MuiGrow, IconButton, ListItemIcon, ListItemText as MuiListItemText, MenuItem as MuiMenuItem, MenuList as MuiMenuList, Paper as MuiPaper, Popper as MuiPopper, } from "@material-ui/core";
                    ...
                    React.createElement(MenuList, { autoFocusItem: open, id: "account-options", onKeyDown: handleListKeyDown },
                        React.createElement(AvatarMenuItem, null,
                            React.createElement(AvatarListItemIcon, null,
                                React.createElement(UserAvatar, { initials: userInitials })),
                            React.createElement(AvatarListItemText, null, user)),
                        (data === null || data === void 0 ? void 0 : data.length) === 0 ? null : React.createElement(Divider, null), data === null || data === void 0 ? void 0 :
                        data.map(d => (React.createElement(MenuItem, null,
