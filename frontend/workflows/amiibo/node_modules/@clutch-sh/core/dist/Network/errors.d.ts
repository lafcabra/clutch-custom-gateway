...
export declare type ErrorDetails = RetryInfo | DebugInfo | QuotaFailure | ErrorInfo | PreconditionFailure | BadRequest | RequestInfo | ResourceInfo | Help | ClutchErrorDetails | any;
 ...
 */
declare const grpcResponseToError: (clientError: AxiosError) => ClutchError;
declare const isHelpDetails: (details: ErrorDetails) => details is Help;
declare const isClutchErrorDetails: (details: ErrorDetails) => details is IClutch.api.v1.ErrorDetails;
