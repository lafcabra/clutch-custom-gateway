...
var _extends = require("@babel/runtime/helpers/extends"), createSerializer = require("./create-serializer-59f8fb90.cjs.prod.js"), enzymeToJson = require("enzyme-to-json");
...
function createEnzymeSerializer(_temp) {
  var _ref = void 0 === _temp ? {} : _temp, classNameReplacer = _ref.classNameReplacer, _ref$DOMElements = _ref.DOMElements, DOMElements = void 0 === _ref$DOMElements || _ref$DOMElements, _ref$includeStyles = _ref.includeStyles, includeStyles = void 0 === _ref$includeStyles || _ref$includeStyles, emotionSerializer = createSerializer.createSerializer({
